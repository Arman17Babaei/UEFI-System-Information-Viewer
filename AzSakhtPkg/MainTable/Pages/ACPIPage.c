...
VOID EFIAPI UpdateShellProtocol() {
    ...
    EFI_STATUS Status = gBS->LocateProtocol(&gEfiShellProtocolGuid, NULL, (VOID **)&ShellProtocol);
    if (EFI_ERROR(Status)) {
...
INT32 GetRsdpAddress(CHAR16 *res) {
    ...
    // if (((CHAR8)((RSDP->Signature >>  0) & 0xFF) != 'R') || ((CHAR8)((RSDP->Signature >>  8) & 0xFF) != 'S') ||
    //     ((CHAR8)((RSDP->Signature >> 16) & 0xFF) != 'D') || ((CHAR8)((RSDP->Signature >> 24) & 0xFF) != ' ') ||
    //     ((CHAR8)((RSDP->Signature >> 32) & 0xFF) != 'P') || ((CHAR8)((RSDP->Signature >> 40) & 0xFF) != 'T') ||
    //     ((CHAR8)((RSDP->Signature >> 48) & 0xFF) != 'R') || ((CHAR8)((RSDP->Signature >> 56) & 0xFF) != ' ')) {
...
INT32 GetRSDPDescription(CHAR16 *res) {
  StrCpyS(res, MAX_DESCRIPTION_LEN, L"The address of RSDT table in the system");
  return 0;
}

PageItem rsdpAddress = {
    .name = L"RSDP Table Placement",
    .GetValue = GetRsdpAddress,
    .GetMoreInformation = GetRSDPDescription,
    .page = NULL,
};
